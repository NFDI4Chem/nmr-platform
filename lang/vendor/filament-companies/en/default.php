...
return [
    ...
    'notifications' => [
        ...
        'company_created' => [
            'title' => 'Group created',
            'body' => 'A new research group has been created with the name **:name**.',
        ],

        'company_deleted' => [
            'title' => 'Group deleted',
            'body' => 'The research group **:name** has been deleted.',
        ],

        'company_invitation_sent' => [
            'title' => 'Invitation sent',
            'body' => 'An invitation has been sent to **:email** to join your research group.',
        ],

        'company_name_updated' => [
            'title' => 'Group updated',
            'body' => 'Your research group name has been updated to **:name**.',
        ],
    ...
    'navigation' => [
        'headers' => [
            ...
            'switch_companies' => 'Switch Groups',
        ],
    ...
    'grid_section_descriptions' => [
        'add_company_employee' => 'Add a new group member to your research group, allowing them to collaborate with you.',
        'browser_sessions' => 'Manage and log out your active sessions on other browsers and devices.',
        'company_name' => "The research group's name and owner information.",
        'create_token' => 'Personal Access Tokens allow third-party services to authenticate with our application on your behalf.',
        'create_company' => 'Create a new research group to collaborate with others on projects.',
    ...
    'action_section_descriptions' => [
        'company_employees' => 'All of the people that are part of this research group.',
        'connected_accounts' => 'Manage and remove your connected accounts.',
        'delete_company' => 'Permanently delete this research group.',
        'pending_company_invitations' => 'These people have been invited to your research group and have been sent an invitation email. They may join the group by accepting the email invitation.',
    ],
    ...
    'modal_descriptions' => [
        ...
        'delete_company' => 'Are you sure you want to delete this research group?',
        'leave_company' => 'Are you sure you would like to leave this research group?',
        'logout_browser_sessions' => 'Please enter your password to confirm you would like to log out of your other browser sessions.',
        'remove_company_employee' => 'Are you sure you would like to remove this person from the research group?',
    ...
    'subheadings' => [
        ...
        'companies' => [
            'company_employee_manager' => 'Please provide the email address of the person you would like to add to this research group.',
            'delete_company' => 'Once a research group is deleted, all of its resources and data will be permanently deleted. Before deleting this group, please download any data or information regarding this group that you wish to retain.',
        ],
    ],
];
